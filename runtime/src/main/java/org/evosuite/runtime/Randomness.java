...
public class Randomness implements Serializable {
    ...
    private static Randomness instance = new Randomness(null);

    private Randomness(Long seed_parameter) {
     ...
     * </p>
     *
     * @return a {@link Randomness} object.
     */
    public static Randomness getInstance() {
        if (instance == null) {
            instance = new Randomness(null);
        }
        return instance;
    }
     ...
     * @return a {@link Randomness} object.
     */
    public static Randomness getInstance(Long seed_parameter) {
        if (instance == null) {
            instance = new Randomness(seed_parameter);
        }
        return instance;
    }
